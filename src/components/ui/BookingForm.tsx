export default function BookingForm() {
  return (
    <div className="flex items-center justify-center bg-gray-100/0 backdrop-blur-sm p-4 rounded-xl text-black ">
      <form className="bg-white p-6 rounded-xl shadow-md w-full max-w-5xl">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="flex-1">
            <select
              ...
              className="mt-1 block w-full border-gray-300 rounded-md shadow-s focus:border-black focus:ring-black sm:text-sm px-3 py-2 w-[150px]"
              required
            >
          ...
          <div className="flex-1">
            <input
              ...
              id="returnDate"
              name="returnDate"
              className="mt-1 block w-full border-gray-300 rounded-md shadow-s focus:border-[#ca8600] focus:ring-[#ca8600] sm:text-sm"
              required
            />
          </div>
